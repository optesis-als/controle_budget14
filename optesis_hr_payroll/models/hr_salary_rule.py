...
class HrPayrollStructure(models.Model):
    ...
    def _get_parent(self):
        return self.env.ref('om_optesis_hr_payroll.structure_base', False)
    ...
    #Vous ne pouvez pas créer une structure salariale récursive
    ...
    def get_all_rules(self):
        ...
        @return : retourne une liste de règles qui sont peut-être à appliquer
        """
        all_rules = []
        for struct in self:
...
class HrSalaryRule(models.Model):
    ...
    condition_python = fields.Text(string='Python Condition', required=True,
        default='''
                    ...
                    # contract: optesis_hr.contract object
    ...
    #Erreur! Vous ne pouvez pas créer de hiérarchie récursive (répété) de règles salariales.
    ...
    def _satisfy_condition(self, localdict):
        """
        @param contract_id: id of optesis_hr.contract to be tested
...
#entrée sur les regles saleriats
